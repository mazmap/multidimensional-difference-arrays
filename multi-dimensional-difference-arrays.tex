...
\begin{frame}[plain]
    ...
    \vspace{0.1cm}
    \( \uparrow \) Slides \( \uparrow \) \par
    \vspace{0.1cm}
    (\texttt{https://github.com/mazmap/multidimensional-difference-arrays})
\end{frame}

\begin{frame}{Who am I?}
    \begin{itemize}[<+->] 
        \item Matteo Mertz 
        \item Finishing my bachelor degree in mathematics at TUM 
        \item Currrently writing my bachelors thesis under the supervision of Professor Bauer and Matthias Söls on the \emph{Efficient computation of Euler characteristic profiles (of cubical filtrations of digital images)}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile] 
    \begin{algorithmic}[1]
	\Statex\hspace{-2em} \textbf{Procedure:} \( \textsc{DiffArr}(D,q_1,\dots,q_L) \)
	...
	\Statex\hspace{-2em} \textbf{Output:} The difference array \( \Delta[q_1,\dots,q_L] \)
